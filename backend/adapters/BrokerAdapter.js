...
class BrokerAdapter extends EventEmitter {
  ...
  /**
   * Alias for dashboards / pipeline (default: delegates to getPositions).
   */
  ...
  /**
   * Pending / working orders (default: none).
   */
  ...
  /**
   * Whether adapter supports a paper / practice account mode.
   */
  supportsPaperMode() {
    return false;
  }
  ...
  /**
   * Close position by symbol or id (optional; not all brokers implement in V1).
   */
