...
/**
 * Example: run Backtest → Performance Analyzer → Strategy Ranking.
 * Run from repo root: node neuropilot_trading_v2/engine/exampleRanking.js
 */
...
console.log('  topStrategies:', ranking.topStrategies);
console.log('  topRegimes:', ranking.topRegimes);
console.log('  recommendations:', ranking.recommendations);
